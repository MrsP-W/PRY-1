...
- ⏸️ **D5.6.4**(下一步,需用户手动):1 封真实邮箱实测(`--real --smtp-provider qq --smtp-username <QQ邮箱脱敏> --recipient <收件人脱敏> --max-recipients 1 --confirm "yes-i-understand-this-sends-real-email"`)
