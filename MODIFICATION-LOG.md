...
| **质量基线** | **3160 passed / 1 skipped** / **90.26%** / mypy --strict 0 / **292 files** / MD lint **298 files** 0 errors(以 `make test` / `make coverage` / `make lint` 实测为准 · `make check-snapshot` 防漂移 · v1.1 进化底座 docs-only + AgentRun + P3) |
