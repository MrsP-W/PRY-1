...
**当前启动候选**:**v0.2.11 全链路重启 7 阶段 dry-run 预演 + 撞坑恢复 3 步实战演练 5 已关闭(2026-06-20)**,**下一步进入 v0.2.12+ 候选决策** — 6/23 周二全链路重启(跑本 dry-run 实战升级 7 阶段);真实 SMTP 发送等用户授权 + 凭据 + B 类白名单决策；W3 真账单 spike 等用户真实 CSV。
