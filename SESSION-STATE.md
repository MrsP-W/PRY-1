...
**当前启动候选**:**v0.2.22 W3 真账单 faker dry-run 已关闭(2026-06-22 深夜)**,**下一步进入 v0.2.22+ / 6/23 实操授权候选** — 阶段 1-5 + launchd + W3 dry-run 已 GO；阶段 6 W3 真账单 spike 等用户真实 CSV；阶段 7 outlook/gmail SMTP 真实 spike 等用户授权 + Keychain 凭据 + B 类白名单决策。
