...
| 核心质量门 | **2611 passed / 1 skipped** · **88.94%** coverage · mypy --strict 0 errors(**238 files**) · MD lint **219 files** 0 errors(以 `make test` / `make coverage` / `make lint` 实测为准 · `make check-snapshot` 防漂移) |
