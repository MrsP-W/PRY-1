...
**当前启动候选（2026-07-20）**：`v0.2.1` tag 已落地；P0–P2 ✅；P3 Day0 collecting；AgentRun 最小闭环（邮件→草稿）已入库。**3145 passed / 1 skipped** / **90.26%** / MD lint **295** / mypy **291 files**；v1.0 默认不打。
...
| 分支 | `main` |
| 当前质量门（2026-07-20） | **3145 passed / 1 skipped** · **90.26%** coverage · mypy --strict 0 errors(**291 files**) · MD lint **295 files** 0 errors；AgentRun `email_to_draft` + P3 Day0 `collecting`；Codex 对话笔记仅显式本地导入。 |
