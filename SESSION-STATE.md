...
| 核心质量门 | **2586 passed / 1 skipped** · **88.92%** coverage · mypy --strict 0 errors(**237 files**) · MD lint **196 files** 0 errors(以 `make test` / `make coverage` / `make lint` 实测为准 · `make lint` = `git ls-files '*.md'`) |
