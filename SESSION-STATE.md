...
| 核心质量门 | **2721 passed / 1 skipped** · **89.08%** coverage · mypy --strict 0 errors(**245 files**) · MD lint **244 files** 0 errors(以 `make test` / `make coverage` / `make lint` 实测为准 · `make check-snapshot` 防漂移) |
