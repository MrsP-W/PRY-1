...
| 核心质量门 | **3030 passed / 1 skipped** · **90.22%** coverage · mypy --strict 0 errors(**263 files**) · MD lint **291 files** 0 errors(以 `make test` / `make coverage` / `make lint` 实测为准 · `make check-snapshot` 防漂移 · v0.2.76 + pitfall-90/91/92/93/94/97/98 → 290) |
