...
>
> **状态**：🎯 **v0.1.0 tag 已落、v0.2.2 实施链推进中**(2026-06-18 复核)。`git tag v0.1.0` 锚定 commit `2af775f` 不动；按用户 6/16 晚指令，本轮不封口 v0.1.0、不跑 6/23 kickstart + seal 脚本、不打 v0.2.0 tag。D1-D7 + D9 Apple Notes + D10 Agent/月报/launchd + 6/16 A/B/C/D 真实 spike 已收口；v0.2 B1/B2/B4 已实化，B-5 已从 pynput 切到 Quartz CGEvent tap，D8 已完成规则异常检测 + 商家画像 + 月报/菜单栏接入 + S11 e2e，D8.5 已完成半真实账单误报修复(new_merchant 拆为 cold_start signal + frequency 精确毫秒时窗)，D8 W3 扩样本已跑到 1000 笔(cold_start 48% → 12%，真异常误报率维持 0%)。**W3 沿 faker 路径收口**(2026-06-17 晚):三阶段验证完整(30/102/1000 笔),真账单 spike 因用户未导出 CSV 推迟到 2026-06-23+ W3 后半段时间窗,不再追加更高量级 faker spike。v0.2.1 #4/#5/#3/#2/#6 已落地(NoteStore 状态机化 + NoteStore L2/L3 跨源去重 + ExpenseServiceImpl 实化 + 真账单 spike 端到端准备 + OAuth 2.0 抽象层 Phase 1),v0.2.1+ NoteStore L2 跨源写入已落地(needs_confirm + candidate_match_id + 0014 migration)。v0.2.2 #1/#2/#3/#6/#7 已落地(NoteStructurerService L2 候选 emit + 1-click 确认 UI + L3 模糊匹配 ±1 day + badge 实时刷新 polling + tests/db FK 循环依赖 57 errors 修复)。v0.2.2 #5 OAuth 2.0 Phase 2 docs-only 启动文档已落,主代码 4 commits 留 6/19-22 实施。Outlook/Gmail SMTP provider 仍为 docs-only 评估,未实施代码。当前 `make test` **2176 passed / 1 skipped / coverage 89.28%**，8/8 质量门全绿。详见 [docs/v0.2.2-p5-oauth-phase2-launch-2026-06-18.md](docs/v0.2.2-p5-oauth-phase2-launch-2026-06-18.md) / [reports/v0.2.2-p7-fk-circular-2026-06-18.md](reports/v0.2.2-p7-fk-circular-2026-06-18.md) / [reports/v0.2.2-p6-badge-realtime-refresh-2026-06-17.md](reports/v0.2.2-p6-badge-realtime-refresh-2026-06-17.md) / [reports/v0.2.2-p3-l3-fuzzy-matching-2026-06-17.md](reports/v0.2.2-p3-l3-fuzzy-matching-2026-06-17.md) / [reports/v0.2.2-p2-1click-confirm-ui-2026-06-17.md](reports/v0.2.2-p2-1click-confirm-ui-2026-06-17.md) / [reports/v0.2.2-p0-l2-emit-2026-06-17.md](reports/v0.2.2-p0-l2-emit-2026-06-17.md)。
...
│       └── menu_bar/         # Mac 菜单栏 UI
├── tests/                    # pytest 单元测试(2176 passed / 1 skipped,覆盖率 89.28%,fail_under=80 硬门槛)
├── docs/                     # 设计文档
...
```bash
make test    # pytest 单元测试(2176 passed / 1 skipped,覆盖率 89.28%,fail_under=80 硬门槛)
```
