...
>
> **当前状态（2026-07-21，优先于下方历史详述）**：LaunchAgent 间隔节流已修；P3 新 Day0=`2026-07-21T18:23:47Z` collecting。**3155 passed / 1 skipped / 90.26%** / MD lint 295。
>
...
│       └── menu_bar/         # Mac 菜单栏 UI
├── tests/                    # pytest 单元测试(以 `make test` 输出为准 · 当前 3155 passed / 1 skipped / 90.26% · fail_under=80 硬门槛)
├── docs/                     # 设计文档
...
```bash
make test    # pytest 单元测试(以 `make test` 输出为准 · 当前 3155 passed / 1 skipped / 90.26% · fail_under=80 硬门槛)
```
