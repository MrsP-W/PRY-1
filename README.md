...
│       └── menu_bar/         # Mac 菜单栏 UI
├── tests/                    # pytest 单元测试(1988 passed / 1 skipped,覆盖率 89.46%,fail_under=80 硬门槛)
├── docs/                     # 设计文档
