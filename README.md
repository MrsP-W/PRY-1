...
>
> **当前状态（2026-07-20，优先于下方历史详述）**：Dashboard 已具备 AI 每日情报台与 Codex 本地对话笔记；P0-4/5、P1 15min 巡检、P1.5 新闻 hourly one-shot 已收口。P2 补齐 IMAP 单封坏 envelope 与新闻坏 XML/坏缓存隔离（Notes/Codex 既有幂等维持）。**3113 passed / 1 skipped / 90.39%** / MD lint 293 / mypy 279 files；下一棒为 P3 7d/30d burn-in。
>
