...
- 严判 type() is None 拒 list[Any]/dict[Any, Any]/set 等非 None 类型
...
def test_approved_rejects_non_int_type(store: OutboxStore) -> None:
    """D5.6.3 P1-1:APPROVED 时 last_approved_at_ms 拒 bool / str / list[Any] / dict[Any, Any] 等非 int。"""
