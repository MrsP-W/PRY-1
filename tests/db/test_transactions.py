...
@pytest.fixture
def store(session_factory: Any) -> TransactionStore:  # type: ignore[name-defined]  # noqa: F821
...
def test_orm_unique_constraint_and_indexes() -> None:
    ...
    unique_constraints = [c for c in table.constraints if isinstance(c, UniqueConstraint)]  # type: ignore[attr-defined]
...
def test_get_by_id_returns_none_when_not_found(store: Any) -> None:
...
def test_list_by_needs_confirm_validates_arguments(store: Any) -> None:
...
def test_list_by_counterparty_filters_by_counterparty_and_date_range(store: Any) -> None:
...
def test_list_by_counterparty_validates_arguments(store: Any) -> None:
...
def test_list_by_source_in_time_window_filters_by_ms_precisely(store: Any) -> None:
...
def test_list_by_source_in_time_window_validates_arguments(store: Any) -> None:
