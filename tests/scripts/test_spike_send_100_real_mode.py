...
测试覆盖(7 cases):
    ...
    B. run_spike 入口严判:
        ...
        5. test_run_spike_count_requires_multi_confirm_when_batch — REAL 模式 count>1 需 --multi-confirm
    C. 凭证链路:
...
def test_run_spike_count_requires_multi_confirm_when_batch(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """D5.6.3:--real 模式 count>1 必传 --multi-confirm(防"我以为是 1 封但实际 10")。"""
    from scripts import spike_send_100  # noqa: PLC0415
