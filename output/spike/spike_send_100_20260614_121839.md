...
> **模式**:⚠️ REAL SMTP (SmtpLibTransport)
> **注入失败**:0 封技术失败
> **注入 BREACH**:0 封 SLA BREACH
> **count**:1
> **smtp_host**:smtp.qq.com:465
> **smtp_username**:477***009@qq.com
...
| 2 | InMemorySmtpTransport.sent_log 行数 == sent | 1 | N/A | N/A |
...
- **D5.6.1 7 项核心验证**:✅
- **D5 启动计划 B3(接真实 SMTP)**:✅ **真正解封**(本次实测 1 封 smtp.qq.com:465 SSL sent=1/1.27s / 状态机 4 步全过)
