...
>
> **状态**：D1-D5.3 已完成（1443 passed / 8 质量门 8/8 全过,2026-06-12 D5.3 业务层接入完成）。D5 业务调度器推进中(D5.4 OutboxDispatcher 待),CalDAV / 菜单栏 / launchd 顺延 D6+。
...
**状态**:D1-D5.3 已完成(D4.8 v1.0.1 commit `2e48179` + D5.1 commit `cce567a` + D5.1-fix `18284fa` + D5.2 `604f937` + D5.3 commit 待),剩 D5 业务调度器 4 子阶段(D5.4 → D5.5 → D5.6 → D5.7)
**维护者**:Mr-PRY
